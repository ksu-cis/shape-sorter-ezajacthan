...
namespace ShapeSorter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Area of a shape is: {shape.Area}");
            }
            Console.WriteLine("-----------------------------");
            ...
            IEnumerable<IShape> circles;
            circles = shapes.OfType<Circle>();

            Console.WriteLine("All circles in shapes");
            ...
            Console.WriteLine("All circles with area < 30");
            ...
            //could even combine them as follows and in either order, no different
